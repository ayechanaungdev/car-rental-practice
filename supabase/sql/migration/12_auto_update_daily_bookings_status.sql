...
BEGIN
  FOR v_booking IN 
    SELECT b.id, b.customer_id, b.driver_id, b.car_id, b.start_date, b.end_date, b.status
  ...
  LOOP
    IF v_booking.status = 'pending' THEN
      ...
      car_id := v_booking.car_id; start_date := v_booking.start_date; end_date := v_booking.end_date; 
